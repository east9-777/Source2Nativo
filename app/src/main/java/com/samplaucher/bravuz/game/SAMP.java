...
public class SAMP extends GTASA implements CustomKeyboard.InputListener, HeightProvider.HeightListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.e(TAG, "Failed to initialize CefBrowser", e);
        }
    ...
    @Override
    public void setCurrentScreenSize(int i, int i2) {
        super.setCurrentScreenSize(i, i2);
    }
