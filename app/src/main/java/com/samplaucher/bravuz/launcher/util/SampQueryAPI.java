...
public final class SampQueryAPI {
    ...
    public SampQueryAPI(String str, int i) {
        ...
        try {
            ...
            if (inetAddress != null) {
                this.f7278b = inetAddress;
                this.f7279c = inetAddress.getHostAddress();
            } else {
                this.f7282f = false;
            }
    ...
    public final String[] mo7164b() {
        ...
        if (!this.f7282f || datagramSocket == null) {
            return null;
        }
    ...
    public final DatagramPacket mo7165c(String str) {
        ...
        try {
            ...
            byte[] address = this.f7278b != null ? this.f7278b.getAddress() : null;
            ...
            return new DatagramPacket(bArr, bArr.length, this.f7278b, i);
        } catch (Exception unused) {
            return null;
        }
    }
    ...
    public boolean mo7166d() {
        ...
        if (bArr2 != null && bArr2.length >= 15 && bArr2[10] == 112 && bArr2[11] == bArr[0] && bArr2[12] == bArr[1] && bArr2[13] == bArr[2] && bArr2[14] == bArr[3]) {
            return true;
        }
        return false;
    }
