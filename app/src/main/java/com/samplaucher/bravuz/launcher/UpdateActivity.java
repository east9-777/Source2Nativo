...
public class UpdateActivity extends AppCompatActivity{
        ...
        public void handleMessage(Message msg) {
            if (msg.what == 4) {
                ...
                if (valueOf == UpdateStatus.DownloadGameData) {
                    ...
                    Log.d("raizrth", "statusname = " + valueOf);
            ...
            {
                Intent intent;
                Log.d("raizrth", "UpdateService.UPDATE_GAME_DATA");
                ...
                if (msg.getData().getBoolean("status", false)) {
                    ...
                    if (mGameApk == null || !mGameApk.exists()) {
                        Log.d("raizrth", "Error update game data");
    ...
    {
        Log.d("raizrth", "request install game");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GLSurfaceView.Renderer mGlRenderer = new GLSurfaceView.Renderer() {
            ...
            public void onSurfaceCreated(GL10 gl10, EGLConfig eglConfig) {
                ...
                Log.e("raizrth", "GPU name: " + glGetString);
                Log.e("raizrth", "GPU type: " + egputype.name());
