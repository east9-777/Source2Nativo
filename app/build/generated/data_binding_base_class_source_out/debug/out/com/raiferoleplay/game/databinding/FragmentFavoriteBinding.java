...
public final class FragmentFavoriteBinding implements ViewBinding {
  ...
  private FragmentFavoriteBinding(@NonNull ConstraintLayout rootView, @NonNull Button buttonServer,
      @NonNull RecyclerView serverRecycler) {
  ...
  public static FragmentFavoriteBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.buttonServer;
      Button buttonServer = ViewBindings.findChildViewById(rootView, id);
      ...
      return new FragmentFavoriteBinding((ConstraintLayout) rootView, buttonServer, serverRecycler);
    }
